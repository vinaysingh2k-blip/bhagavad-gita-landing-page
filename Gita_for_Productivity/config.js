/* ==========================================================================
   Page-specific configuration — Landing Page 5: "Gita for Productivity"
   Loaded BEFORE ../assets/main.js. Replace placeholders before launch.
   ========================================================================== */
window.PAGE_CONFIG = {
  PRODUCT_NAME: 'Gita for Productivity — 12-Chapter Original Companion',
  DOWNLOAD_FILE: '../assets/downloads/gita-for-productivity.pdf',
