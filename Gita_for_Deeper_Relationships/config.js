/* ==========================================================================
   Page-specific configuration — Landing Page 11: "Gita for Deeper Relationships"
   Loaded BEFORE ../assets/main.js. Replace placeholders before launch.
   ========================================================================== */
window.PAGE_CONFIG = {
  PRODUCT_NAME: 'Gita for Deeper Relationships — 12-Chapter Original Companion',
  DOWNLOAD_FILE: '../assets/downloads/gita-for-deeper-relationships.pdf',
