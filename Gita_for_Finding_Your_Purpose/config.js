/* ==========================================================================
   Page-specific configuration — Landing Page 9: "Gita for Finding Your Purpose"
   Loaded BEFORE ../assets/main.js. Replace placeholders before launch.
   ========================================================================== */
window.PAGE_CONFIG = {
  PRODUCT_NAME: 'Gita for Finding Your Purpose — 12-Chapter Companion',
  DOWNLOAD_FILE: '../assets/downloads/gita-for-finding-your-purpose.pdf',
